...
path    = '/Users/zhanglingyi/Documents/NLP/training'  ### REPLACE HERE!
...
You can use the data you extract from the training set as a database you check against. 3b prob wsd 3a
 location parse
